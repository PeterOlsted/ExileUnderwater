...
//[CustomPropertyDrawer(typeof(EventTestAttribute))]
//public class EventTestDrawer : PropertyDrawer
//{
//    EventTestAttribute EventAttribute { get { return ((EventTestAttribute)attribute); } }
...
//            if (GUI.Button(buttonPos, "Post"))
//            {
//                HDRSystem.PostEvent(EventAttribute.);
//            }
...
//        GUI.Button(labelPos, "Drag event here to add to add event");
