...
//HDR Audio is not endorsed by Daniele Giardini
...
public class UndoCheck
{
    ...
    private static UndoCheck undoCheck;

    public static UndoCheck Instance
    {
        get
        {
            if(undoCheck == null)
                 undoCheck = new UndoCheck(null, "");
            return undoCheck;
        }
    }
    ...
    /// </param>
    public UndoCheck(Object p_target, string p_name) : this(p_target, p_name, true) { }
    /// <summary>
    /// Creates a new HOEditorUndoManager. 
    /// </summary>
    /// <param name="p_target">
    ...
    /// </param>
    public UndoCheck(Object p_target, string p_name, bool p_autoSetDirty)
    {
        defTarget = p_target;
        defName = p_name;
